...
<div class="editor-wrapper">
    <div class="addTaskHeader">
        ...
        <button id="closeAddTaskButton" onclick="closeCard(), sortTask(), clearForm('assigned-contacts-popup', 'subTasks-popup'), removeListeners('add-contact-input'),setEditFormOpenedToFalse();"><svg xmlns="http://www.w3.org/2000/svg"
